...
const styles = StyleSheet.create({
  ...
  scroll: { padding: 16, gap: 16, paddingBottom: 110 },
  summaryRow: { flexDirection: 'row', gap: 12 },
  summaryCard: { flex: 1, padding: 14, gap: 4, borderWidth: 1, borderColor: Colors.gray[200] },
  summaryVal: { fontSize: 18, fontWeight: '700' },
  summaryLabel: { fontSize: 10, color: Colors.gray[400] },
  chartCard: { padding: 16, borderWidth: 1, borderColor: Colors.gray[200] },
  ...
  aiCard: { backgroundColor: Colors.white, borderWidth: 1, borderColor: Colors.gray[200], padding: 16, gap: 6 },
  aiTitle: { fontSize: 11, fontWeight: '700', color: Colors.cloud[700] },
  aiText: { fontSize: 11, color: Colors.cloud[700], lineHeight: 17 },
  vitalsCard: { padding: 16, borderWidth: 1, borderColor: Colors.gray[200] },
  vitalsTitle: { fontSize: 13, fontWeight: '700', color: Colors.gray[700], marginBottom: 10 },
  vitalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: Colors.white },
